 ...
 */
package net.spryservers.sprydav.syncadapter
...
import net.spryservers.sprydav.*
import net.spryservers.sprydav.log.Logger
import net.spryservers.sprydav.resource.LocalCollection
import net.spryservers.sprydav.resource.LocalResource
import net.spryservers.sprydav.settings.ISettings
import net.spryservers.sprydav.ui.AccountSettingsActivity
import net.spryservers.sprydav.ui.DebugInfoActivity
